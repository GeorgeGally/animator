...
p.image = function(_img, _x, _y, _w, _h) {
	this.drawImage(_img, _x, _y, _w, _h);
}
...
p.strokeWeight = function(_i) {
	this.lineWidth = _i;
}

p.slowClear = function (c, cc){
	if (cc == undefined) cc = rgba(0,0,0,c/100);
	this.fillStyle = rgba(0,0,0,c/100);
	this.fillRect(0,0,width, height);
}

p.fade = function (c, cc){
	if (cc == undefined) cc = rgba(0,0,0,c/100);
	this.fillStyle = rgba(0,0,0,c/100);
	this.fillRect(0,0,width, height);
}	

p.fillColor = function(f){
	this.fillStyle = f;
	//console.log(f);
}

p.strokeColor = function(f){
	this.strokeStyle = f;
}
